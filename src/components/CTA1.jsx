...
const CTA1 = () => {
    return (
        <div style={{ backgroundImage: `var(--bg-CTA1)` }} className='bg-cover bg-center flex flex-col md:flex-row gap-8 justify-center items-center px-[30px] lg:px-[60px] py-[100px]'>
            ...
            <div className='flex flex-col flex-1 justify-center items-center'>
                ...
                <button className='flex justify-center items-center gap-3 bg-yellow-green py-2 px-12 md:py-4 md:px-21 rounded-50 font-bold text-sm lg:text-lg text-charcoal mt-8'>Get Started
