...
const Features = () => {
    return (
        <div className='pl-[60px] md:pl-[80px] py-[100px] bg-[url(/assets/images/feature_bg.png)] bg-cover bg-center grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-16 md:gap-5'> 
            <div className='flex flex-col items-center md:items-start pl-0 px-[60px] md:px-0'>
                ...
                <Link className='inline-flex justify-center items-center gap-3 bg-white py-2 px-8 md:py-[14px] md:px-[65px] rounded-50 font-bold text-sm md:text-lg text-charcoal mt-5 hover:bg-charcoal hover:text-white transition-all duration-300'>Get Started
